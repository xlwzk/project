...
public class TsGiftDao extends DataDao {
	...
	//查询所有礼品
	public List<TsGift>  getGiftList(Integer nowPage,Integer pageSize,String sort,String order){
	...
	//添加礼品
	public Integer addGift (String gname,String gpic,Integer greqscore,Integer gcount,Integer gsum,String gdesc){
		String sql="insert into ts_gift values(ts_gift_seq.nextval,?,?,?,?,?,?)";
		Integer i=update(sql,gname,gpic,greqscore,gcount,gsum,gdesc);
		return i;
	}
	//删除礼品
	...
	public Integer updateGift(String gname,String gpic,Integer greqscore,Integer gcount,Integer gsum,String gdesc,Integer gid){
		String sql="update ts_pay set gname=?,gpic=?,greqscore=?,gcount=?,gsum=?,gdesc=? where gid=? ";
