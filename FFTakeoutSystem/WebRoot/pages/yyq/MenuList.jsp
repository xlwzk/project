...
<html>
  ...
  <body>
    ...
    <tr>
    <td width="25%" align="center"><a href="#"><img src="image/${m.mupic}"width="143" height="112" border="0" /></a></td>
    <td><h2>${m.muname}</h2><h4>${m.mudesc}</h4><h3 style="color: red">￥${m.muprice}</h3></td>
    </tr>
    </c:forEach>
    </table>
